...
int getival(symbol *, int *);
int getfval(symbol *, float *);
symbol *sym_add(symbol *, symbol *);
symbol *sym_sub(symbol *, symbol *);
symbol *sym_mul(symbol *, symbol *);
symbol *sym_div(symbol *, symbol *);
#endif
